...
// Calendly link — update this to your actual Calendly URL
const CALENDLY_URL = 'https://calendly.com/bilal-lania-elipsestudio/15-mins-meeting?month=2026-07';
    ...
    return (
        <section className="bg-black px-[15px] py-3 md:hidden">
            <div className="flex justify-start w-full">
                ...
                >
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 md:w-5 md:h-5 shrink-0">
