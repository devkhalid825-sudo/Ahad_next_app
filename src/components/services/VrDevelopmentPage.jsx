      ...
      <section className="px-5 md:px-8 py-10 md:py-[6rem] bg-[#0D0D0D]">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-[3rem] items-stretch">
          <div className="flex-1">
            ...
            <div className="md:hidden"><TextCarousel texts={["Ready to deploy enterprise VR? See how Elipse Studio's VR development services deliver measurable training and commercial results.", "Virtual reality is no longer future technology — it is present-day business infrastructure. Enterprises deploy VR for training that reduces workplace incidents. Real estate developers deploy VR for sales centers that close international buyers. Manufacturers deploy VR for product demonstrations impossible in traditional formats.", "Elipse Studio delivers VR development services for enterprises, real estate developers, manufacturers, healthcare organizations, and specialty brands worldwide. Since 2021, we have built VR experiences that deliver measurable business outcomes — not impressive demos that generate press but produce no commercial results."]} /></div>
            <div className="hidden md:block">
              ...
              <ReadText text="Elipse Studio delivers VR development services for enterprises, real estate developers, manufacturers, healthcare organizations, and specialty brands worldwide. Since 2021, we have built VR experiences that deliver measurable business outcomes — not impressive demos that generate press but produce no commercial results." />
            </div>
          </div>
          <div className="flex-1 bg-[#111] rounded-lg p-5 md:p-[2rem] text-[#F2F0EB]">
            ...
            <div className="text-sm md:text-lg font-light leading-relaxed text-white/70">
              Elipse Studio delivers custom VR development services for enterprise training, sales enablement, immersive marketing, and simulation applications. Our VR development supports Meta Quest 3, HTC Vive Focus, PICO 4 Enterprise, and premium Varjo XR-4 platforms. Powered by Unreal Engine 5 and Unity, we build production-ready VR experiences for clients worldwide since 2021.
            </div>
