...
const AnimationPage = () => {
  ...
  <>
    <div className="w-full overflow-x-hidden bg-[#0D0D0D] text-[#F2F0EB] selection:bg-[#4169E1]/30 selection:text-[#F2F0EB]">
      ...
      <ServiceRelatedLinks relatedServices={[{label:'3D Product Animation',to:'/services/product-animation'},{label:'Architectural Visualization',to:'/services/architectural-visualization'},{label:'VFX & Virtual Production',to:'/services/vfx-virtual-production'}]} relatedArticles={[{label:'Industrial 3D Animation: Communicating Complexity Visually',to:'/blog/industrial-animation'},{label:'Why Animated Videos Drive More Engagement',to:'/blog/animated-videos-engagement'},{label:'Educational Animation in 2026',to:'/blog/educational-animation-2026'}]} /><LatestWork /><ClientReviews /><div id="contact"><Contact /></div><Footer />
    </div>
