      ...
      <section className="px-5 md:px-8 py-10 md:py-[6rem] bg-[#0D0D0D]">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
          <div className="flex-1">
            ...
            <div>
              <ReadText text="Our award-winning creative team brings diverse expertise across branding, design, motion, and production. We deliver end-to-end production from concept to final delivery, ensuring consistency and quality at every stage." />
