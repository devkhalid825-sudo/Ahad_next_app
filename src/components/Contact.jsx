        ...
        <section id="contact" className="py-10 md:py-16 bg-black text-white overflow-hidden">
            <div className="mx-auto px-6 md:px-16 max-w-8xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-start">
                    ...
                    {/* Right Column: Form Card - Responsive Rounding */}
                        ...
                        <form ref={form} onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-3 md:space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 md:gap-4">
                                        <button
                                            ...
                                            className={`px-5 py-3 md:px-6 md:py-3 rounded-full border md:text-sm text-[13px] transition-all ${formData.interest === 'Get a Quote' ? 'bg-white text-black border-white' : 'border-white/20 hover:bg-white/10'}`}
                                        >
                                            Get a Quote
                                        </button>
                                        <button
                            ...
                            <div className="grid grid-cols-2 md:gap-x-10 md:gap-y-6 gap-x-5 gap-y-4 pt-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        onBlur={handleBlur}
                                        className={`w-full bg-white/10 border rounded-lg px-4 py-3 focus:border-[#4169E1] outline-none transition-colors text-sm md:text-base placeholder:text-gray-400 ${errors.user_name && touched.user_name ? 'border-red-500' : 'border-white/30'}`}
                            ...
                            <div className="space-y-4">
                                ...
                                <button
                                    ...
                                    className={`w-full bg-[#4169E1] hover:bg-[#8ab4ff] text-black md:font-bold py-3.5 md:py-4 rounded-full text-sm md:text-base transition-all transform active:scale-[0.98] ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                                >
                        ...
                        <div className="mt-8 pt-6 border-t border-white/10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <a
                                    ...
                                    data-el-track="whatsapp-contact-section"
                                    className="flex items-center justify-center gap-4 bg-[#25D366]/5 hover:bg-[#25D366]/15 text-[#25D366] border border-[#25D366]/20 py-4 md:py-5 px-5 md:px-8 rounded-2xl transition-all duration-300 group hover:shadow-[0_0_20px_rgba(37,211,102,0.15)]"
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    data-el-track="schedule-intro-call-contact-section"
                                    className="flex items-center justify-center gap-4 bg-[#4169E1]/5 hover:bg-[#4169E1]/15 text-[#4169E1] border border-[#4169E1]/20 py-4 md:py-5 px-5 md:px-8 rounded-2xl transition-all duration-300 group hover:shadow-[0_0_20px_rgba(65,105,225,0.1)]"
                                >
                ...
                {submitStatus && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
                        <div className="bg-[#111111] border border-white/10 rounded-[2rem] p-8 md:p-12 max-w-lg w-full text-center shadow-2xl transform animate-in zoom-in-95 duration-300">
